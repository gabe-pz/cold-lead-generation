...
def main() -> None:
    csv_name: str = input('Enter the name of your filtered csv: ')
    search_amount: int = int(input('How many businesses to search this run? '))

    input_path: str = f'step-1/step-2/filtered-csvs/{csv_name}.csv' 
    output_path: str = f'step-1/step-2/leads/{csv_name}-and-cleaned.csv' 
